        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="mb-4 p-4">
            <p className="text-justify">
              ...
              <br />
              Assim que sai da AtualCard Fui chamado para trabalhar em uma
              empresa de Geolocalização e Mapeamento de Cidades, onde eu era
              responsável pela análise e conferência de dados coletados em
              campos, e em pouco tempo eu já estava ajudando meus pares e
              tomando cada vez mais responsabilidades. E nessa empresa foi onde
              eu tive um primeiro contato direto com programação. Por ser
              curioso acabei observando que a empresa usava Python e SQL e
              aquilo me acendeu uma chama de interesse por aprender programação
              que eu acabei não alimentando tanto na época. Depois de um tempo
              sai da empresa para tentar empreender. Acabou que não deu certo e
              eu segui em frente.
              <br />
              ...
              <br />
              Primeiramente tentei entrar numa escola chamada Driven, me
              inscrevi no processo seletivo e não passei. Mas como eu estava
              decidido a cursar algo que me fizesse entrar na área procurei uma
              outra escola no mesmo modelo e encontrei a Trybe na qual me
              inscrevi e apesar de ter um processo seletivo mais longo consegui
              passar de primeira.
              <br />
              Ao estudar programação vi que é a área que eu quero trabalhar no
              resto da minha vida, pois através dela posso mudar e melhorar a
              vida de muitas pessoas. Além de que na área há um senso de
              comunidade muito grande, onde as pessoas se ajudam e colaboram
              para criar coisas novas. Minha primeira experiência com isso foi
              na Trybe, onde participei de uma iniciativa chamada VolunTrybers
              onde alunos se disponibilizavam para ajudar outros alunos que
              estivessem com dúvidas. Através disso, pude melhorar minhas
              habilidades comportamentais e evoluir como pessoa.
            </p>
          </div>
          <img
            src={minhaFoto}
